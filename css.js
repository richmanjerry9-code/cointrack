...
:root{
  ...
  /* Executive Accents (Gold mapped to primary/green classes) */
  --green: #d4af37; 
...
.login-feat svg{color:var(--green);filter:drop-shadow(0 0 4px var(--green-dim))}
...
.hist-day-header{display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:linear-gradient(90deg, var(--card), transparent);border-left:2px solid var(--green);border-radius:0 12px 12px 0;margin-bottom:10px;cursor:pointer;user-select:none;transition:background 0.2s}
.hist-day-header:hover{background:linear-gradient(90deg, var(--card2), transparent)}
.hist-day-label{font-size:13px;font-weight:800;color:var(--txt);font-family:var(--mono);letter-spacing:0.5px}
.hist-day-right{display:flex;align-items:center;gap:12px}
.hist-day-net{font-family:var(--mono);font-size:13px;font-weight:700}
.hist-day-net.pos{color:var(--green)}.hist-day-net.neg{color:var(--txt2)}
